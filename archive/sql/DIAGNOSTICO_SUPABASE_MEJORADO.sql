...
-- Ejecuta ESTE en lugar del anterior
-- ============================================================
...
SELECT 'ESTRUCTURA DE requisition_items:' as info
UNION ALL
...
-- 11. VERIFICAR SI PURCHASE ORDER ITEMS EXISTE Y SU ESTRUCTURA
SELECT 'ESTRUCTURA DE purchase_order_items:' as info
UNION ALL
SELECT column_name || ' (' || data_type || ')'
FROM information_schema.columns
